    ...
    <div className={styles.dashboard}>
      ...
      <section className={styles.dashboardContent}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <Title level={3} style={{ color: '#8dff9d', marginTop: 0 }}>
              用户管理
            </Title>
            <Text style={{ color: '#7ea687' }}>
        ...
        <div style={{ marginTop: 16, maxWidth: 420, display: 'flex', gap: 12, alignItems: 'center' }}>
          <div style={{ color: '#7ea687', minWidth: 40 }}>搜索</div>
          <Input
            value={query}
